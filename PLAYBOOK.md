...
| 구성 | 금액 |
|------|------|
| 기본 구축 (메인+케이스+SEO풀세트+어드민) | **정가 5,900,000원** |
| 레퍼런스 고객 한정 (선착순 3~5곳) 50% 할인 | **2,950,000원** |
| 시술 상세페이지 | 1페이지당 50,000원 |
| 외국어 1개 (영어·일어·중국어 등) | 650,000원 |
| 온라인 예약 페이지 | 300,000원 |
| 카카오채널 연동 | 300,000원 |
| 완전 신규 디자인 | 500,000원 |
| AI 이미지 세트 (10장) | 200,000원 |
| **월 유지보수 — 베이직** (모니터링+분기리포트) | 250,000원/월 |
| **월 유지보수 — 스탠다드** (베이직+월1회 콘텐츠) | 400,000원/월 |
| **월 유지보수 — GEO 액티브 운영** (구조화데이터 갱신+AI인용 모니터링+신규시술 SEO+검색성과 리포트) | 1,300,000원/월 |

> 2026-07-27 가격 개정: 시장 조사(경쟁 패키지 300~800만원대, 다국어 시장가는 제작비의 50%, GEO 대행은 월 30만~500만원) 반영. 배경은 `CONTEXT.md` "가격 단가" 섹션 참고. "무제한 반값" 프레임을 "선착순 한정 특가"로 바꿔 향후 소개 고객에게도 같은 가격을 요구받는 문제를 방지.

> **기본 포함 범위 (2026-07-27 확정)**: 관리자 패널(`templates/admin/`)과 케이스/후기 페이지는 템플릿 재사용이라 원가가 거의 없으므로 **기본 구축에 포함**. 반면 외국어 페이지는 번역 검수(의료 콘텐츠 오역 리스크)와 hreflang/OG/JSON-LD 언어별 세팅이라는 실제 작업이 들어가므로 **영어를 포함해 언어당 유료 옵션**. 온라인 예약·카카오 연동·완전 신규 디자인·AI 이미지 세트도 옵션 유지.
